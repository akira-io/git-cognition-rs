...
use git_cognition::{RequestMethod, Visibility};
...
#[test]
fn bitbucket_repo_branch_create_builds_post_request() -> git_cognition::CognitionResult<()> {
    let repo = bitbucket()
        .repo()
        .owner("akira-io")
        .name("git-cognition-rs")
...
#[test]
fn bitbucket_repo_branch_delete_builds_delete_request() -> git_cognition::CognitionResult<()> {
    let repo = bitbucket()
        .repo()
        .owner("akira-io")
        .name("git-cognition-rs")
