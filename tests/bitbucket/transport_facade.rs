...
use git_cognition::{TelemetryEvent, auth, cognition, rate_limit, repo, run_async_test, telemetry};

#[test]
fn bitbucket_facade_composes_middleware_retry_and_rate_limit() -> git_cognition::CognitionResult<()>
{
