...
use git_cognition::{LifecycleState, Repo, ReposFluent, Visibility, repo, run_async_test};

#[test]
fn bitbucket_client_hydrates_repository() -> git_cognition::CognitionResult<()> {
...
#[test]
fn bitbucket_client_hydrates_repository_list() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn bitbucket_client_hydrates_repository_create() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let repository = bitbucket()
...
#[test]
fn bitbucket_client_hydrates_repository_update() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let repository = bitbucket()
            .body(r#"{"full_name":"akira-io/git-cognition-rs","is_private":false}"#)
            .repos()
...
#[test]
fn bitbucket_client_deletes_repository() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        bitbucket()
            .status(204)
            .repos()
...
#[test]
fn bitbucket_client_hydrates_branches_and_commits() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn bitbucket_client_hydrates_branch_create() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn bitbucket_client_deletes_branch() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        bitbucket()
            .status(204)
            .repos()
