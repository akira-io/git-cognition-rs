...
use git_cognition::{CognitionError, PipelinesFluent, Repo, repo, run_async_test};

#[test]
fn bitbucket_client_hydrates_pipeline_get_and_list() -> git_cognition::CognitionResult<()> {
...
#[test]
fn bitbucket_client_hydrates_pipeline_cancel() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn bitbucket_client_reports_unvalidated_pipeline_rerun() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
