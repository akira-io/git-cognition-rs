...
use git_cognition::{IssuesFluent, Repo, repo, run_async_test};

#[test]
fn bitbucket_client_hydrates_issue_get_and_list() -> git_cognition::CognitionResult<()> {
...
#[test]
fn bitbucket_client_hydrates_issue_mutations() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
