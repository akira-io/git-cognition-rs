use git_cognition::bitbucket::{BitbucketProvider, bitbucket};
use git_cognition::{RequestMethod, auth, cognition, rate_limit, repo, run_async_test};
...
#[test]
fn bitbucket_facade_builds_pipeline_requests() -> git_cognition::CognitionResult<()> {
...
#[test]
fn bitbucket_facade_executes_repo_client_with_auth() -> git_cognition::CognitionResult<()> {
...
#[test]
fn bitbucket_facade_executes_repo_client_with_middleware() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let transport = bitbucket()
            .body(r#"{"full_name":"akira-io/git-cognition-rs","is_private":false}"#)
            .record();
...
#[test]
fn bitbucket_facade_executes_client_with_configured_base_url() -> git_cognition::CognitionResult<()>
{
    run_async_test(async {
        let transport = bitbucket()
            .body(r#"{"full_name":"akira-io/git-cognition-rs","is_private":false}"#)
...
#[test]
fn bitbucket_facade_executes_repo_client_with_retry() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn bitbucket_facade_observes_rate_limit_headers() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
fn repository() -> git_cognition::ManagedRepo<BitbucketProvider> {
    cognition()
        .provider(bitbucket())
        .repo()
        .owner("akira-io")
