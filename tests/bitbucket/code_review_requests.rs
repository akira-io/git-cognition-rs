...
fn repository() -> git_cognition::ManagedRepo<git_cognition::bitbucket::BitbucketProvider> {
    bitbucket()
        .repo()
        .owner("akira-io")
        .name("git-cognition-rs")
...
-> git_cognition::ManagedCodeReview<git_cognition::bitbucket::BitbucketProvider> {
