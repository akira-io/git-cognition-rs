use git_cognition::{Transport, rate_limit, request, response, run_async_test, test_transport};
...
#[test]
fn rate_limit_transport_records_configured_headers() -> git_cognition::CognitionResult<()> {
