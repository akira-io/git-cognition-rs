...
#[test]
fn gitlab_repo_branch_create_builds_post_request() -> git_cognition::CognitionResult<()> {
    let repo = gitlab()
        .repo()
        .owner("akira-io")
        .name("git-cognition-rs")
...
#[test]
fn gitlab_repo_branch_delete_builds_delete_request() -> git_cognition::CognitionResult<()> {
    let repo = gitlab()
        .repo()
        .owner("akira-io")
        .name("git-cognition-rs")
