...
use git_cognition::{CodeReviewsFluent, IssuesFluent, ReleasesFluent, Repo, repo, run_async_test};

#[test]
fn gitlab_client_hydrates_issue_get_and_list() -> git_cognition::CognitionResult<()> {
...
#[test]
fn gitlab_client_hydrates_issue_mutations() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn gitlab_client_hydrates_code_review_get_and_list() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn gitlab_client_hydrates_code_review_mutations() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn gitlab_client_hydrates_release_get_and_list() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn gitlab_client_hydrates_release_mutations() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
