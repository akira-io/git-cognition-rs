use git_cognition::gitlab::{GitLabProvider, gitlab};
...
#[test]
fn gitlab_facade_builds_pipeline_requests() -> git_cognition::CognitionResult<()> {
...
#[test]
fn gitlab_facade_executes_repo_client_with_auth() -> git_cognition::CognitionResult<()> {
...
#[test]
fn gitlab_facade_executes_repo_client_with_middleware() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let transport = gitlab()
            .body(r#"{"path_with_namespace":"akira-io/git-cognition-rs","visibility":"public"}"#)
            .record();
...
#[test]
fn gitlab_facade_executes_client_with_configured_base_url() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let transport = gitlab()
            .body(r#"{"path_with_namespace":"akira-io/git-cognition-rs","visibility":"public"}"#)
            .record();
...
#[test]
fn gitlab_facade_executes_repo_client_with_retry() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn gitlab_facade_observes_rate_limit_headers() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
fn repository() -> git_cognition::ManagedRepo<GitLabProvider> {
    cognition()
        .provider(gitlab())
        .repo()
        .owner("akira-io")
