...
#[test]
fn gitlab_repo_lists_preserve_next_cursor() -> git_cognition::CognitionResult<()> {
...
#[test]
fn gitlab_collaboration_lists_preserve_next_cursor() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let issues = gitlab()
            .header("x-next-page", "3")
            .body(r#"[{"iid":42}]"#)
...
#[test]
fn gitlab_pipeline_lists_preserve_next_cursor() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
