...
#[test]
fn gitlab_client_hydrates_repository() -> git_cognition::CognitionResult<()> {
...
#[test]
fn gitlab_client_hydrates_repository_list() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn gitlab_client_hydrates_repository_create() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let repository = gitlab()
            .body(
...
#[test]
fn gitlab_client_hydrates_repository_update() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let repository = gitlab()
            .body(
...
#[test]
fn gitlab_client_deletes_repository() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        gitlab()
            .status(202)
            .repos()
...
#[test]
fn gitlab_client_hydrates_branches_and_commits() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn gitlab_client_hydrates_branch_create() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let branch = gitlab()
            .body(r#"{"name":"feature"}"#)
            .repos()
...
#[test]
fn gitlab_client_deletes_branch() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        gitlab()
            .status(204)
            .repos()
