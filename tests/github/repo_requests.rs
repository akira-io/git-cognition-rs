...
#[test]
fn github_repo_branch_create_builds_post_request() -> git_cognition::CognitionResult<()> {
    let repo = github()
        .repo()
        .owner("akira-io")
        .name("git-cognition-rs")
...
#[test]
fn github_repo_branch_delete_builds_delete_request() -> git_cognition::CognitionResult<()> {
    let repo = github()
        .repo()
        .owner("akira-io")
        .name("git-cognition-rs")
