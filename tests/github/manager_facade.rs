use git_cognition::github::{GitHubProvider, github};
...
#[test]
fn github_facade_builds_pipeline_requests() -> git_cognition::CognitionResult<()> {
...
#[test]
fn github_facade_executes_repo_client_with_auth() -> git_cognition::CognitionResult<()> {
...
#[test]
fn github_facade_executes_repo_client_with_middleware() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let transport = github()
            .body(r#"{"full_name":"akira-io/git-cognition-rs","private":false}"#)
            .record();
...
#[test]
fn github_facade_executes_client_with_configured_base_url() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let transport = github()
            .body(r#"{"full_name":"akira-io/git-cognition-rs","private":false}"#)
            .record();
...
#[test]
fn github_facade_executes_repo_client_with_retry() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn github_facade_observes_rate_limit_headers() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
fn repository() -> git_cognition::ManagedRepo<GitHubProvider> {
    cognition()
        .provider(github())
        .repo()
        .owner("akira-io")
