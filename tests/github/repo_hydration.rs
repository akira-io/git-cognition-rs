...
#[test]
fn github_client_hydrates_repository() -> git_cognition::CognitionResult<()> {
...
#[test]
fn github_client_hydrates_repository_list() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn github_client_hydrates_repository_create() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let repository = github()
            .body(
...
#[test]
fn github_client_hydrates_repository_update() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let repository = github()
            .body(
                r#"{"full_name":"akira-io/git-cognition-rs","private":false,"archived":false,"disabled":false}"#,
...
#[test]
fn github_client_deletes_repository() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        github()
            .status(204)
            .repos()
...
#[test]
fn github_client_hydrates_branches_and_commits() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn github_client_hydrates_branch_create() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let branch = github()
...
#[test]
fn github_client_deletes_branch() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        github()
            .status(204)
            .repos()
