...
fn repository() -> git_cognition::ManagedRepo<git_cognition::github::GitHubProvider> {
    github()
        .repo()
        .owner("akira-io")
        .name("git-cognition-rs")
...
fn code_review_resource() -> git_cognition::ManagedCodeReview<git_cognition::github::GitHubProvider>
{
