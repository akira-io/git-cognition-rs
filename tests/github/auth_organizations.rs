...
use git_cognition::{OrganizationKind, auth, cognition, run_async_test};

#[test]
fn github_authentication_validate_targets_authenticated_user_endpoint()
-> git_cognition::CognitionResult<()> {
...
#[test]
fn github_client_hydrates_authenticated_user_organizations() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
