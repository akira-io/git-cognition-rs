...
#[test]
fn github_client_hydrates_pipeline_get_and_list() -> git_cognition::CognitionResult<()> {
...
#[test]
fn github_client_hydrates_pipeline_commands() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
