...
#[test]
fn github_client_hydrates_issue_get_and_list() -> git_cognition::CognitionResult<()> {
...
#[test]
fn github_client_hydrates_issue_mutations() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn github_client_reports_unsupported_issue_delete() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let result = github()
            .body("{}")
            .issues()
...
#[test]
fn github_client_hydrates_code_review_get_and_list() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn github_client_hydrates_code_review_mutations() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn github_client_reports_unsupported_code_review_delete() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
        let result = github()
            .body("{}")
            .code_reviews()
...
#[test]
fn github_client_hydrates_release_get_and_list() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
...
#[test]
fn github_client_hydrates_release_mutations() -> git_cognition::CognitionResult<()> {
    run_async_test(async {
